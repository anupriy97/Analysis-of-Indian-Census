...
df = pd.read_csv("ACC_road_cond.csv",low_memory=False)
df2  = pd.read_csv("road_funds2013_14_15_16.csv",low_memory=False)
df3   = pd.read_csv("population.csv",low_memory=False)
d = df.columns
